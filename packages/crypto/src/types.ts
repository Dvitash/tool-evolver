...
export interface EncryptedVaultOptions {
   ...
   * If omitted, attempts to read from TOOL_EVOLVER_VAULT_PASSPHRASE or generates a deterministic machine key.
   */
  passphrase?: string;
...
export interface KeychainOptions {
  /**
   * Service name used in system keychain (default: "tool-evolver").
   */
  serviceName?: string;
