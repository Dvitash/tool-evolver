import type { ToolManifest, ToolOutputSchema, ToolParameterSchema } from "@tool-evolver/contracts";
 ...
 */
export const DENO_WORKER_BOOTSTRAP_SOURCE = `// Tool Evolver Deno Worker Bootstrap Script
