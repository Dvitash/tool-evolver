...
describe("HTTP OpenAPI & Request/Response Contracts", () => {
  it("defines a valid and complete OpenAPI 3.1 specification", () => {
    ...
    expect(OPENAPI_V1_SPEC.info.title).toContain("Tool Evolver");
  ...
  it("validates installation and workspace registration schemas", () => {
    ...
    const workspaceReq = {
      ...
      installationId: "inst-001",
      deviceId: "dev-001",
      name: "tool-evolver-monorepo",
      rootPath: "/home/user/project",
      capabilityEnvelope: {
        envelopeId: "env-001",
        workspaceId: "ws-001",
        fs: { readPaths: ["."], writePaths: ["dist"], allowWorkspaceRoot: true, allowTemp: true, denyPaths: [".git"], maxFileSizeBytes: 10485760 },
        ...
        limits: { maxConcurrentExecutions: 4, maxCpuUsagePercent: 100, maxMemoryMb: 256, maxExecutionTimeMs: 30000, maxOutputSizeBytes: 1048576 },
