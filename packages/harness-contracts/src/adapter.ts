...
export interface HarnessAdapter {
  ...
  /**
   * Generates a planned mutation to wire the Tool Evolver Gateway MCP server
  ...
  /**
   * Verifies that the harness configuration is correctly wired to Tool Evolver Gateway.
   */
