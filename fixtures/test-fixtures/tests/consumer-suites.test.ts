  ...
  describe("Storage Round-Trip Suite", () => {
    it("runs successfully against an in-memory StorageAdapter", async () => {
      const storageState = {
        ...
        candidates: new Map<string, EvolutionCandidate>(),
      ...
      const mockStorage: StorageAdapter = {
        ...
        async saveEvolutionCandidate(candidate) {
          storageState.candidates.set(candidate.id, candidate);
        },
        async getEvolutionCandidate(id) {
          return storageState.candidates.get(id) || null;
        },
  ...
  describe("Registry Suite", () => {
    it("runs successfully against a compliant RegistryAdapter", async () => {
      ...
      const mockRegistry: RegistryAdapter = {
        ...
        async updateCandidateState(candidateId, newState) {
