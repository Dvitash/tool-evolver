...
function buildTestCases(includeNegative = true): TestCaseDef[] {
  const cases: TestCaseDef[] = [
    ...
    {
      name: "valid_evolution_candidate",
      contractType: "EvolutionCandidate",
      category: "domain",
      payload: goldenDomain.validEvolutionCandidate,
      expectedValid: true,
    },
    {
      name: "valid_evaluation_result",
      contractType: "EvaluationResult",
      category: "domain",
      payload: goldenDomain.validEvaluationResult,
      expectedValid: true,
    },
    {
  ...
  if (includeNegative) {
    ...
    cases.push(
      ...
      {
        name: "invalid_candidate_score_out_of_range",
        contractType: "EvolutionCandidate",
        category: "domain",
        payload: goldenDomain.invalidDomainFixtures.invalidCandidateScoreOutOfRange,
        expectedValid: false,
      },
      {
