...
export const validHarnessWorkspace: HarnessWorkspace = {
  ...
  name: "Tool Evolver",
  harnessId: "cline",
  configPath: "/workspaces/tool-evolver/.cline/config.json",
  metadata: {},
};
...
export const validConfigBackup: ConfigBackup = {
  backupId: "bak_001",
  targetPath: "/workspaces/tool-evolver/.cline/config.json",
  backupPath: "/workspaces/tool-evolver/.cline/config.json.bak_001",
