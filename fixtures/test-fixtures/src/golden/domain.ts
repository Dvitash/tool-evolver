...
export const validToolManifest: ToolManifest = {
  ...
  metadata: { author: "Tool Evolver Autonomous Synthesizer" },
...
export const validEvolutionCandidate: EvolutionCandidate = {
  id: "cand_001",
  workspaceId: FIXTURE_WORKSPACE_ID,
  state: "detected",
  trigger: {
    reason: "repeated_pattern",
    evidenceEventIds: ["evt_call_001"],
    sessionOccurrences: 5,
    detectedAt: FIXTURE_TIMESTAMP,
    patternFrequency: 4.5,
    estimatedLatencySavingsMs: 350,
    estimatedTokenSavings: 1200,
  },
  proposedTool: validToolManifest,
  requiredCapabilities: validToolManifest.capabilities,
  evaluationSummary: {
    benchmarkScore: 0.95,
    replaySuccessRate: 1.0,
    latencyImprovementPercent: 35.0,
    tokenSavingsPercent: 42.0,
    securityVerdict: "passed",
    evaluatorVersion: "1.0.0",
    evaluatedAt: FIXTURE_TIMESTAMP,
  },
  sourceCode: "export async function run(args) { return { matches: [] }; }",
  createdAt: FIXTURE_TIMESTAMP,
};
...
export const validToolVersion: ToolVersion = {
  ...
  artifact: {
    artifactDigest: FIXTURE_DIGEST,
    bundleReference: {
      uri: "file:///workspace/.tool-evolver/bundles/fast_ast_grep.bundle.js",
      hash: FIXTURE_DIGEST,
      sizeBytes: 8192,
      format: "js_bundle",
    },
  ...
  history: [
    {
      ...
      actor: { type: "daemon", id: "tool-evolver-daemon" },
      metadata: {},
    },
  ],
...
export const validEvaluationResult: EvaluationResult = {
  ...
  overallDecision: {
    ...
    confidence: 0.99,
    threshold: 0.85,
    notes: "Exceeded all performance and security criteria.",
    evaluatedBy: "EvaluatorWorker-v1",
    evaluatedAt: FIXTURE_TIMESTAMP,
  },
  dimensions: [
    {
      ...
      threshold: 0.9,
      passed: true,
      metrics: { passedTests: 12, totalTests: 12 },
    },
    {
      name: "security",
      weight: 0.35,
      ...
      threshold: 1.0,
      passed: true,
      metrics: { forbiddenSyscalls: 0, unauthorizedFileAccess: 0 },
    },
    {
      name: "latency",
      weight: 0.2,
      ...
      threshold: 0.7,
      passed: true,
      metrics: { speedupMultiplier: 3.2, p95Ms: 14.5 },
    },
    {
      name: "token_savings",
      weight: 0.2,
      ...
      threshold: 0.6,
      passed: true,
      metrics: { savedTokensPerTurn: 450 },
    },
  ],
  replayTestCount: 15,
  replaySuccessCount: 15,
  securityChecklist: {
    noUnbrokeredFs: true,
    noArbitraryEval: true,
    noLeakedEnvSecrets: true,
  },
...
export const validWorkspaceRecord: WorkspaceRecord = {
  workspaceId: FIXTURE_WORKSPACE_ID,
  rootPath: "/workspaces/tool-evolver",
  name: "Tool Evolver Core",
  config: {},
...
export const invalidDomainFixtures = {
  ...
  invalidCandidateScoreOutOfRange: {
    ...validEvolutionCandidate,
    evaluationSummary: {
      ...validEvolutionCandidate.evaluationSummary,
      benchmarkScore: 1.5,
    },
  },
