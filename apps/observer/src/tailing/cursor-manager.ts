import type { SyncCursor } from "@tool-evolver/contracts";
import type { LocalDatabaseConnection, LocalStateStore, SessionRepository } from "@tool-evolver/db";
import { type SourceCursor, SourceCursorSchema } from "@tool-evolver/harness-contracts";
...
/**
 * Atomic checkpoint manager advancing SourceCursor in SQLite via @tool-evolver/db
