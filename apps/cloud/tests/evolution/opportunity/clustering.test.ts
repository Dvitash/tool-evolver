...
describe("StructuralClusterer", () => {
  it("should cluster structurally similar episodes together into a single cluster", () => {
    ...
    const events1 = [
      createToolCallEvent({ eventId: "e1_1", sessionId: "sess-1", toolName: "read_file", parameters: { path: "src/a.ts" } }),
      createToolResultEvent({ eventId: "e1_2", sessionId: "sess-1", toolCallId: "e1_1", result: "ok" }),
      createFileEditEvent({ eventId: "e1_3", sessionId: "sess-1", filePath: "src/a.ts" }),
    ];

    const events2 = [
      createToolCallEvent({ eventId: "e2_1", sessionId: "sess-2", toolName: "read_file", parameters: { path: "src/b.ts" } }),
      createToolResultEvent({ eventId: "e2_2", sessionId: "sess-2", toolCallId: "e2_1", result: "ok" }),
      createFileEditEvent({ eventId: "e2_3", sessionId: "sess-2", filePath: "src/b.ts" }),
    ];

    const events3 = [
      createToolCallEvent({ eventId: "e3_1", sessionId: "sess-3", toolName: "read_file", parameters: { path: "src/c.ts" } }),
      createToolResultEvent({ eventId: "e3_2", sessionId: "sess-3", toolCallId: "e3_1", result: "ok" }),
  ...
  it("should separate distinct workflow patterns into separate clusters", () => {
    ...
    // Pattern A: read -> edit
    const eventsA = [
      createToolCallEvent({ eventId: "a1", sessionId: "sess-1", toolName: "read_file", parameters: { path: "src/a.ts" } }),
    ...
    const eventsB = [
      createCommandExecEvent({ eventId: "b1", sessionId: "sess-2", command: "git checkout -b feature" }),
