...
/**
 * Tool Evolver Binary Smoke Verification Tool
 *
 * Validates:
...
export const BINARY_SPECS = [
  {
    ...
    packageDir: "apps/cli",
    binKey: "tool-evolver",
    binPath: "apps/cli/dist/bin/cli.js",
    testArgs: ["--help"],
    expectedOutputPattern: /Tool Evolver CLI/i,
  },
  {
    packageName: "@tool-evolver/observer",
    packageDir: "apps/observer",
    binKey: "tool-evolver-daemon",
    binPath: "apps/observer/dist/bin/daemon.js",
    testArgs: ["--help"],
    expectedOutputPattern: /Tool Evolver Daemon/i,
  },
  {
    packageName: "@tool-evolver/gateway",
    packageDir: "apps/gateway",
    binKey: "tool-evolver-mcp",
    binPath: "apps/gateway/dist/bin/mcp-shim.js",
    testArgs: ["--help"],
    expectedOutputPattern: /Tool Evolver MCP Shim/i,
  },
  {
    packageName: "@tool-evolver/test-fixtures",
    packageDir: "fixtures/test-fixtures",
    binKey: "tool-evolver-conformance",
    binPath: "fixtures/test-fixtures/dist/cli.js",
    testArgs: ["--help"],
